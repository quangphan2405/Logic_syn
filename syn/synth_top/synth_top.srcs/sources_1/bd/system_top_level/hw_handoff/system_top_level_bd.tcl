...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set pin_aud_bclk [ create_bd_port -dir O pin_aud_bclk ]
  ...
  set pin_clk125mhz [ create_bd_port -dir I -type clk pin_clk125mhz ]
...
CONFIG.MMCM_CLKOUT0_DIVIDE_F {14.500} \
...
CONFIG.C_SIZE {1} \
  ...
  connect_bd_net -net clk_in1_1 [get_bd_ports pin_clk125mhz] [get_bd_pins clk_wiz_0/clk_in1]
  ...
  connect_bd_net -net i2c_config_0_param_status_out [get_bd_pins i2c_config_0/param_status_out] [get_bd_pins util_vector_logic_0/Op1]
  connect_bd_net -net i2c_config_0_sclk_out [get_bd_ports pin_i2c_sclk] [get_bd_pins i2c_config_0/sclk_out]
  connect_bd_net -net keys_in_1 [get_bd_ports pin_keys] [get_bd_pins synthesizer_0/keys_in] [get_bd_pins util_vector_logic_0/Op2]
  connect_bd_net -net pin_rst_n_1 [get_bd_ports pin_rst_n] [get_bd_pins util_vector_logic_1/Op2]
  connect_bd_net -net synthesizer_0_aud_bclk_out [get_bd_ports pin_aud_bclk] [get_bd_pins synthesizer_0/aud_bclk_out]
  ...
  connect_bd_net -net util_vector_logic_0_Res [get_bd_ports pin_leds_i2c] [get_bd_pins util_vector_logic_0/Res]
  connect_bd_net -net util_vector_logic_1_Res [get_bd_pins i2c_config_0/rst_n] [get_bd_pins synthesizer_0/rst_n] [get_bd_pins util_vector_logic_1/Res]
